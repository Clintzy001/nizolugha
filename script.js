...
// Replace these with your actual project details from the Supabase Dashboard
 ...
 * This ensures progress is synced across devices.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveStats() {
        ...
        // Trigger cloud sync whenever stats are saved locally
    ...
    function updateLessonUI() {
        ...
        document.querySelector('.native-word').innerText = lesson.phrase;
        document.querySelector('.translation').innerText = `"${lesson.meaning}"`;
    ...
    if (nextBtn) {
        nextBtn.addEventListener('click', (e) => {
            ...
            if (currentLanguageData && currentPhraseIndex < currentLanguageData.lessons.length - 1) {
                ...
                // SAVING LOCALLY AND SYNCING TO CLOUD
                saveStats(); 
